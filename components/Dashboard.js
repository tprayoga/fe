...
const Dashboard = () => {
  ...
  return (
    <div className='bg-[#FAFAFA]'>
       <div className="container h-screen md:px-20 pl-2 pr-4 ">
        {/* SEARCH BAR */}
        <div className="flex mt-4 mb-4 w-full gap-4">
            <label class="relative w-full ">
                ...
                <input class="placeholder:text-p block border rounded py-1.5 pl-9 pr-3 focus:outline w-full ease-in-out duration-100 " placeholder="Search..." type="text" name="search"/>
            </label>
