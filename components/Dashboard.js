      ...
      <div className="h-screen md:px-20 pl-2 pr-4 bg-[#FAFAFA]">
        ...
        <div className="flex pt-4 mb-4 w-full gap-4">
          <label className="relative w-full ">
            ...
            <input
              className="placeholder:text-p block border rounded py-1.5 pl-9 pr-3 focus:outline text-slate-200 w-full ease-in-out duration-100 "
              placeholder="Search..."
              type="text"
              name="search"
            />
          ...
          <div className="bg-black flex items-center justify-center rounded hover:bg-white border border-black ease-in-out duration-150 group cursor-pointer sm:w-1/3 xl:w-1/5">
            <button className="text-white px-3 group-hover:text-black sm:hidden">
              +
            </button>
            <Link href="/new">
              <button className="text-white px-3 group-hover:text-black hidden sm:inline-block">
                + New Project
              </button>
            </Link>
          </div>
        ...
        <div className="">
          <a
            href="#"
            className="flex w-full justify-between items-center border-b pb-4 pt-4 hover:bg-slate-100"
          >
